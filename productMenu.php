	...
	<body class>
		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				<div class="container">
						<h2>Welcome My Commercial Farm</h2>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="grain" style="color: black;">tuber</option>
									<option value="grain" style="color: black;">legumes</option>
									<option value="grain" style="color: black;">cashcrops</option>
